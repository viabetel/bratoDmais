...
export function InstallationModule({ categorySlug, productName, basePrice, onSelect }: InstallationModuleProps) {
  ...
  const installationServices = getServicesByType('installation', categorySlug)
  ...
  return (
    <>
      <div className="border-t border-gray-200 pt-4 mt-4">
        ...
        <div className="mt-3 flex gap-2">
          ...
          >
            ...
            {selected ? 'Agendamento Ativo' : 'Agendar Instalação'}
          </Button>
      ...
      <ServiceSchedulingModal
        ...
        onConfirm={(booking) => {
          console.log('[v0] Instalação agendada:', booking)
          setShowScheduling(false)
        }}
      />
    </>
